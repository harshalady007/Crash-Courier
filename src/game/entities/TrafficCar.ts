...
export class TrafficCar {
  ...
  constructor(
    ...
    this.sprite = scene.matter.add.sprite(x, y, "traffic");
    this.sprite.setBody({ type: "rectangle", width: 48, height: 82 });
    this.sprite.setMass(35);
    this.sprite.setFrictionAir(0.08);
  }
  update(): void {
    ...
    this.sprite.setVelocity(Math.cos(a) * this.speed, Math.sin(a) * this.speed);
  }
}
